...
namespace JabilEjercicio.Controllers
{
    public class BuildingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Pkbuilding,Building1")] Building building)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Pkbuilding,Building1")] Building building)
        {
